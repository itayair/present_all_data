...
dict_word_to_his_synonym, dict_longest_span_to_counter = main_clustering.convert_examples_to_clustered_data()
...
f_file = open("load_data/longest_span_to_counter.pkl", "wb")
...
pickle.dump(dict_longest_span_to_counter, f_file)
f_file.close()
e_file.close()
d_file.close()
c_file.close()
