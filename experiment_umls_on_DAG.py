...
def main():
    ...
    DAG_utils.remove_redundant_nodes(topic_objects)
    DAG_utils.update_score(topic_objects, dict_span_to_rank)
    ...
    top_k_topics, already_counted_labels, all_labels = \
        hierarchical_structure_algorithms.extract_top_k_concept_nodes_greedy_algorithm(
            100, topic_objects, global_index_to_similar_longest_np)
