...
# get_quantity_for_nodes(topic_object_lst)
# global_index_to_similar_longest_np = all_data_dict['global_index_to_similar_longest_np']
# dict_span_to_rank = all_data_dict['dict_span_to_rank']
# global_dict_label_to_object = all_data_dict['global_dict_label_to_object']
